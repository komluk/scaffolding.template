    ...
    <body>
        <div class="landing">
            <header class="landing-header">
                ...
                <h1 class="landing-title">dotnet-app</h1>
                <div class="landing-badges">
                    <span class="badge badge-stack">.NET</span>
            ...
            <section class="section">
                ...
                <div class="card">
                    <ul class="file-tree">
                        <li><span class="file-name">Program.cs</span><span class="file-desc">Application entry point and routes</span></li>
                        <li><span class="file-name">App.csproj</span><span class="file-desc">Project configuration and dependencies</span></li>
            ...
            <section class="section">
                ...
                <div class="card">
                    <ol class="steps">
                        <li><span class="step-text">Clone the repository</span></li>
                        <li><span class="step-text">Run the app with <code>dotnet run</code></span></li>
                        <li><span class="step-text">Edit <code>Program.cs</code> to add endpoints and logic</span></li>
