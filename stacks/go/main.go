...
<body>
    <div class="landing">
        <header class="landing-header">
            ...
            <h1 class="landing-title">go-app</h1>
            <div class="landing-badges">
                <span class="badge badge-stack">Go</span>
        ...
        <section class="section">
            ...
            <div class="card">
                <ul class="file-tree">
                    <li><span class="file-name">main.go</span><span class="file-desc">HTTP server and route handlers</span></li>
                    <li><span class="file-name">go.mod</span><span class="file-desc">Go module definition</span></li>
        ...
        <section class="section">
            ...
            <div class="card">
                <ol class="steps">
                    ...
                    <li><span class="step-text">Run the server with <code>go run main.go</code></span></li>
                    <li><span class="step-text">Edit <code>main.go</code> to add handlers and logic</span></li>
