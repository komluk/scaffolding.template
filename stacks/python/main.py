...
<body>
    <div class="landing">
        <header class="landing-header">
            ...
            <h1 class="landing-title">python-app</h1>
        ...
        <section class="section">
            ...
            <div class="card">
                <ul class="file-tree">
                    <li><span class="file-name">main.py</span><span class="file-desc">FastAPI application and routes</span></li>
                    <li><span class="file-name">requirements.txt</span><span class="file-desc">Python dependencies</span></li>
        ...
        <section class="section">
            ...
            <div class="card">
                <ol class="steps">
                    <li><span class="step-text">Clone the repository and create a virtual environment with <code>python -m venv venv</code></span></li>
                    <li><span class="step-text">Install dependencies with <code>pip install -r requirements.txt</code></span></li>
                    <li><span class="step-text">Start the dev server with <code>uvicorn main:app --reload</code></span></li>
                    <li><span class="step-text">Edit <code>main.py</code> to add endpoints and logic</span></li>
        ...
        <section class="section">
            ...
            <div class="card">
                <ul class="file-tree">
                    ...
                    <li><span class="file-name">GET /docs</span><span class="file-desc">Interactive API documentation (Swagger)</span></li>
                </ul>
            </div>
        </section>
